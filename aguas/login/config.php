...
$from_email = 'aguas@agencia-v.com'; //Webmaster email
$from_name = 'Confirmación'; //"From name" displayed on email

//Find specific server settings at https://www.arclab.com/en/kb/email/list-of-smtp-and-pop3-servers-mailserver-list.html
$mailServerType = 'smtp';
//IF $mailServerType = 'smtp'
$smtp_server = 'smtpout.secureserver.net';
$smtp_user = 'aguas@agencia-v.com';
$smtp_pw = 'aguasucr';
...
$signupthanks = 'Gracias por registrase! Recibirá un correo brevemente para confirmar su cuenta.';
